    ...
    return (
        isVisible && (
            <nav className="w3-sidebar" id="hiddenSidebar" aria-label="Main Navigation">
                <button onClick={toggleSidebar} className="w3-button w3-display-topright" id="closeButton" aria-label="Close Sidebar">
                    <i className="fa fa-remove fa-lg" aria-hidden="true"></i>
                </button>
