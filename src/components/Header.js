...
function Header() {
    ...
    return (
        <header className="w3-container w3-center" id="header">
            ...
            <img src="img/fotoCV.jpg" className="w3-image w3-hide-large w3-hide-small w3-round" id="home-img-medium" alt="Portfolio"/>
            <img src="img/fotoCV.jpg" className="w3-image w3-hide-large w3-hide-medium w3-round" id="home-img-small" alt="Portfolio"/>
